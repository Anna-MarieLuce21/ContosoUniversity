...
namespace ContosoUniversity.Data
{
    ...
    {
        public static void Initialize(SchoolContext context, string xmlPath = @"C:\Users\annam\OneDrive\Desktop\school work\ContosoUniversity\ContosoUniversity\Data\seed.xml")
        {
            ...
            foreach (EnrollementDto e in seed.Enrollements)
                {
                    Grade? grade = null;
                    ...
                    var enrollement = new Enrollment { Student = studentDict[e.StudentRef]
                                                     , Course = courseDict[e.CourseRef]
                                                     , Grade = grade
                                                     };

                    context.Enrollments.Add(enrollement);
                }
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(SeedDto));
            ...
            {
                string msg = $"Failed to deserialize '{path}'. {ex.InnerException?.Message}";
